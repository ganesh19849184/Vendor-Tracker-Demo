...
function ClosedRequest() {
    ...
    const [allClosedRequest,setAllClosedRequest] = useState([])
    ...
    const apiData = async e =>{
        ...
        result = await axios.get(apiUrl+`closedRequest`);
        setAllClosedRequest(result.data);  
