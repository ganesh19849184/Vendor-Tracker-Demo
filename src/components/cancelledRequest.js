...
function CancelledRequest() {
    ...
    const [allcancelledRequest,setAllCancelledRequest] = useState([])
    ...
    const apiData = async e =>{
        ...
        result = await axios.get(apiUrl+`cancelledRequest`);
        setAllCancelledRequest(result.data);  
     ...
     allcancelledRequest.map((item, i) => {
