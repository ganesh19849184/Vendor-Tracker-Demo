...
function AddRequest() {
    ...
    const { dor_time, request_from, co_ordinator, source_language, target_language, service_type, particulars, status, createdBy, date_of_closure } = requestData;
    ...
    const sourceLanguage = (e) => {
        var arCurrentLang = [];
        e.map((obj) => {
            arCurrentLang.push(obj.value)
        })
        setRequestData({ ...requestData, source_language: arCurrentLang })
    }

    const targetLanguage = (e) => {
        var arCurrentLang = [];
        e.map((obj) => {
            arCurrentLang.push(obj.value)
        })
        setRequestData({ ...requestData, target_language: arCurrentLang })
    }
                            ...
                            <div className="row">
                                <div className="col">
                                    ...
                                    <Multiselect
                                        ...
                                        displayValue="key"
                                        showCheckbox={true} id="source_language" name="source_language"   
                                ...
                                <div className="col">
                                    <label for="exampleFormControlSelect1">Target</label>
                                      <Multiselect
                                        options={languageList}
                                        displayValue="key"
                                        showCheckbox={true} id="target_language" name="target_language"   
