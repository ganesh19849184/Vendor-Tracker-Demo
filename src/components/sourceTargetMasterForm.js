...
function SourceTargetMasterForm(){
    ...
    const [valueErr,setValueErr] = useState([])
     ...
     async function insertSourceTargetMaster(){
        const isValid = formValidation();
        if(isValid == true)
        {

        
        let request = await fetch(apiUrl+'sourceTargetInsert',{
            method : 'POST',
            cache: 'no-cache',
            headers : {
...
<div className="row">
                                ...
                                <br/>
                                    ...
                                    <button className="btn btn-primary btn-user btn-block"  type="button" onClick={insertSourceTargetMaster}> 
                                        Insert
                                    </button>
...
export default SourceTargetMasterForm;